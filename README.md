...
The prediction tells a company what offers are preferred by an individual customer. The customer demographic and offer details are added to the model to make a prediction. The results are discussed in the report file below: <br/>
```Starbucks_analysis.pdf```<br/>
